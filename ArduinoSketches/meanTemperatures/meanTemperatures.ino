...
void setup() {
  ...
  int index = startDay; // index we start reading from meansT from
  while (index < (startDay + 365)) { // step through temperature information

    Serial.println(index);
    Serial.println(index % 365);
    Serial.println("***************************************");


    float historicT = pgm_read_float(&means2018[index - startDay]);
    float recentT = pgm_read_float(&meansT[index % 365]);
